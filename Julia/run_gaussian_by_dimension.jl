...
CSV.write(string("gaussian-results-by-dimension-correlation", correlations, "-with-refresh-", refresh_rate,"-discrstep-", discr_step_ZZ, "-timeadaps-", time_adaps_ZZ,"-discrESS-", discr_step_ESS, "-horizon-",time_horizon_ZZ, ".csv"), df)
