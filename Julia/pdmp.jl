...
function ExtractSamplesFunction(fun::Function, t_skeleton::Vector{Float64}, x_skeleton::Vector{Vector{Float64}}, v_skeleton::Vector{Vector{Float64}}, n_samples::Int; x_ref::Vector{Float64} = Vector{Float64}(undef,0), ellipticQ::Bool=false)
